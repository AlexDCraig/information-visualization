...
\node (pro2) [process, right of=pro1, xshift=6cm] {Grab Player Statistics From Database};
\node (in2) [io, below of=pro2, yshift=-0.5cm] {Access pChart API};
\node (pro3) [process, below of=in2, yshift=-0.5cm] {Draw radar chart};
\node (pro4) [process, right of=pro3, xshift=4cm] {Draw bar chart 1};
\node (pro5) [process, right of=pro4, xshift=4cm] {Draw bar chart 2};

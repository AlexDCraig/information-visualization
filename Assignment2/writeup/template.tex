...
\node (in1) [io, below of=start] {CSV File of Statistics};
\node (pro1) [process, below of=in1] {Plug Statistics of Players into Database};
\node (pro2) [process, right of=pro1] {Grab Player Statistics From Database};
\node (in2) [io, below of=pro2] {Access pChart API};
\node (pro3) [process, below of=in2] {Draw radar chart};
\node (pro4) [process, right of=pro3] {Draw bar chart 1};
\node (pro5) [process, right of=pro4] {Draw bar chart 2};
\node (stop) [startstop, below of=pro5] {Produce pCharts for viewing};
